 ...
 *Get a USB configuration descriptor based on its index idx.
 *Returns 0 on success, LIBUSB_ERROR_NOT_FOUND if the configuration does not exist and a LIBUSB_ERROR code on error.
 **/
